...
Begin VB.Form frmConfirmacionOrden 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Confirmaciones - Ordenes de Inversión"
   ClientHeight    =   9540
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   13920
   ...
   Begin VB.CommandButton cmdReversar 
      ...
      Height          =   735
      Left            =   8610
      Picture         =   "frmConfirmacionOrden.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   153
      Top             =   8760
      Width           =   1200
   ...
   Begin VB.CommandButton cmdProcesar 
      ...
      Height          =   735
      Left            =   10050
      Picture         =   "frmConfirmacionOrden.frx":0625
      Style           =   1  'Graphical
      TabIndex        =   120
      Top             =   8760
      Width           =   1200
   ...
   Begin TabDlg.SSTab tabConfirmacionOrden 
      ...
      EndProperty
      TabCaption(0)   =   "Lista"
      TabPicture(0)   =   "frmConfirmacionOrden.frx":0B8D
      ...
      TabPicture(1)   =   "frmConfirmacionOrden.frx":0BA9
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "fraNotaCredito"
      Tab(1).Control(1)=   "fraAcreencias"
      Tab(1).Control(2)=   "cmdAccion"
      Tab(1).Control(3)=   "txtObservacion"
      Tab(1).Control(4)=   "fraDatosFL2"
      Tab(1).Control(5)=   "fraDatosFL1"
      Tab(1).Control(6)=   "fraDatos"
      Tab(1).Control(7)=   "lblDescrip(45)"
      Tab(1).Control(8)=   "lblDescrip(7)"
      Tab(1).Control(9)=   "lblPrecio(0)"
      Tab(1).Control(10)=   "lblDescrip(2)"
      Tab(1).Control(11)=   "lblPrecio(1)"
      Tab(1).Control(12)=   "lblDescrip(3)"
      Tab(1).Control(13)=   "lblTirNeta(0)"
      Tab(1).Control(14)=   "lblDescrip(16)"
      Tab(1).Control(15)=   "lblTirNeta(1)"
      ...
      Begin VB.Frame fraNotaCredito 
         ...
         Begin TAMControls.TAMTextBox txtInteresAFavor 
            ...
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0BC5
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
         ...
         Begin TAMControls.TAMTextBox txtIGVAFavor 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0BE1
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
         ...
         Begin TAMControls.TAMTextBox txtTotalNotaCredito 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0BFD
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
      ...
      Begin VB.Frame fraAcreencias 
         ...
         Begin TAMControls.TAMTextBox txtIGVComisionDesembolso 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0C19
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
         ...
         Begin TAMControls.TAMTextBox txtCapital 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0C35
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
         ...
         Begin TAMControls.TAMTextBox txtInteres 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0C51
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
         ...
         Begin TAMControls.TAMTextBox txtIGVInteres 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0C6D
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
         ...
         Begin TAMControls.TAMTextBox txtComisionDesembolso 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0C89
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
         ...
         Begin TAMControls.TAMTextBox txtMontoTotal 
            ...
            ForeColor       =   -2147483640
            Locked          =   -1  'True
            Container       =   "frmConfirmacionOrden.frx":0CA5
            Text            =   "0.00"
            Decimales       =   2
            Estilo          =   4
            Apariencia      =   1
      ...
      Begin TrueOleDBGrid60.TDBGrid tdgConsulta 
         Bindings        =   "frmConfirmacionOrden.frx":0CC1
         Height          =   5385
         Left            =   360
         OleObjectBlob   =   "frmConfirmacionOrden.frx":0CDB
         TabIndex        =   95
         Top             =   2700
         Width           =   13065
      End
      Begin VB.Frame fraDatosFL2 
         Caption         =   "Comisiones y Monto Total (FL2)"
         Height          =   4635
         Left            =   -68100
         TabIndex        =   61
         Top             =   2910
      ...
      Begin VB.Frame fraCriterio 
         ...
         Begin VB.CommandButton cmdExportarExcel 
            ...
            Height          =   735
            Left            =   11640
            Picture         =   "frmConfirmacionOrden.frx":652F
            Style           =   1  'Graphical
            TabIndex        =   124
            Top             =   1200
            Width           =   1200
   ...
   End
End
Attribute VB_Name = "frmConfirmacionOrden"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
Attribute VB_Description = "Ficha de Confirmación de Ordenes y Generación de Operaciones"
Option Explicit
...
Private Sub LlenarFormulario(strModo As String)
    ...
    Select Case strModo
        Case Reg_Edicion
            ...
            .CommandText = "SELECT * FROM InversionOrden WHERE CodFondo='" & strCodFondo & "' AND CodAdministradora='" & gstrCodAdministradora & "' AND " & _
            ...
            If Not adoRegistro.EOF Then
                ...
                lblAgente.Caption = Valor_Caracter
                .CommandText = "SELECT DescripPersona FROM InstitucionPersona WHERE CodPersona='" & adoRegistro("CodAgente") & "' AND " & _
                    "TipoPersona='" & Codigo_Tipo_Persona_Agente & "'"
                Set adoTemporal = .Execute
                
                If Not adoTemporal.EOF Then
                    lblAgente.Caption = Trim(adoTemporal("DescripPersona"))
                End If
                adoTemporal.Close
                
                lblEmisor.Caption = Valor_Caracter
                .CommandText = "SELECT DescripPersona FROM InstitucionPersona WHERE CodPersona='" & adoRegistro("CodEmisor") & "' AND " & _
                ...
                '*** Acreencias ***
                If adoRegistro("CodFile") = CodFile_Descuento_Comprobantes_Pago Or adoRegistro("CodFile") = CodFile_Descuento_Documentos_Cambiario Or adoRegistro("CodFile") = CodFile_Descuento_Flujos_Dinerarios Then
                    ...
                    txtInteresAFavor.Text = CStr(adoRegistro("InteresCorridoMFL2"))
                    txtIGVAFavor.Text = CStr(adoRegistro("MontoIgvMFL2"))
                    
                    InteresNC = adoRegistro("InteresCorridoMFL2")
                    IGVNC = adoRegistro("MontoIgvMFL2")
                    TotalNC = InteresNC + IGVNC
                    txtTotalNotaCredito.Text = CStr(TotalNC)
                    
                    txtComisionDesembolso.Text = CStr(adoRegistro("MontoAgenteMFL1"))
                    txtIGVComisionDesembolso(0).Text = CStr(adoRegistro("MontoImptoComision"))
                    txtMontoTotal.Text = CStr(adoRegistro("MontoTotalMFL1"))
                Else
                ...
                '*** MFL1 ***
                lblPrecio(0).Caption = CStr(adoRegistro("PrecioUnitarioMFL1"))
                lblTirNeta(0).Caption = CStr(adoRegistro("TirNeta"))
                lblSubTotal(0).Caption = CStr(adoRegistro("MontoSubTotalMFL1"))
                lblSubTotal(2).Caption = CStr(adoRegistro("MontoSubTotalMFL1"))
                txtComisionAgente(0).Text = CStr(adoRegistro("MontoAgenteMFL1"))
                txtComisionBolsa(0).Text = CStr(adoRegistro("MontoBolsaMFL1"))
                txtComisionCavali(0).Text = CStr(adoRegistro("MontoCavaliMFL1"))
                txtComisionFondo(0).Text = CStr(adoRegistro("MontoFondoLiquidacionMFL1"))
                txtComisionFondoG(0).Text = CStr(adoRegistro("MontoFondoGarantiaMFL1"))
                txtComisionConasev(0).Text = CStr(adoRegistro("MontoConasevMFL1"))
                txtComisionGastoBancario(0).Text = CStr(adoRegistro("MontoGastoBancarioMFL1"))
                txtComisionEspecial(0).Text = CStr(adoRegistro("MontoComisionEspecialMFL1"))
                lblComisionIgv(0).Caption = CStr(adoRegistro("MontoIgvMFL1"))
                txtInteresCorrido(0).Text = CStr(adoRegistro("InteresCorridoMFL1"))
                txtVacCorrido(0).Text = CStr(adoRegistro("VacCorrido"))
                lblMontoTotal(0).Caption = CStr(adoRegistro("MontoTotalMFL1"))
                lblMontoTotal(2).Caption = CStr(adoRegistro("MontoTotalMFL1"))
                
                '*** MFL2 ***
                lblPrecio(1).Caption = CStr(adoRegistro("PrecioUnitarioMFL2"))
                lblTirNeta(1).Caption = "0"
                lblSubTotal(1).Caption = CStr(adoRegistro("MontoSubTotalMFL2"))
                txtComisionAgente(1).Text = CStr(adoRegistro("MontoAgenteMFL2"))
                txtComisionBolsa(1).Text = CStr(adoRegistro("MontoBolsaMFL2"))
                txtComisionCavali(1).Text = CStr(adoRegistro("MontoCavaliMFL2"))
                txtComisionFondo(1).Text = CStr(adoRegistro("MontoFondoLiquidacionMFL2"))
                txtComisionFondoG(1).Text = CStr(adoRegistro("MontoFondoGarantiaMFL2"))
                txtComisionGastoBancario(1).Text = CStr(adoRegistro("MontoGastoBancarioMFL2"))
                txtComisionEspecial(1).Text = CStr(adoRegistro("MontoComisionEspecialMFL2"))
                txtComisionConasev(1).Text = CStr(adoRegistro("MontoConasevMFL2"))
                lblComisionIgv(1).Caption = CStr(adoRegistro("MontoIgvMFL2"))
                txtInteresCorrido(1).Text = CStr(adoRegistro("InteresCorridoMFL2"))
                lblMontoTotal(1).Caption = CStr(adoRegistro("MontoTotalMFL2"))
                
                txtObservacion.Text = Trim(adoRegistro("Observacion"))
                
                fraDatosFL2.Visible = True
                lblPrecio(1).Visible = True: lblTirNeta(1).Visible = True
                lblDescrip(2).Visible = True: lblDescrip(16).Visible = True
                If CDec(adoRegistro("PrecioUnitarioMFL2")) = 0 Then
                    fraDatosFL2.Visible = False
                    lblPrecio(1).Visible = False: lblTirNeta(1).Visible = False
                    lblDescrip(2).Visible = False: lblDescrip(16).Visible = False
                End If
            End If
            adoRegistro.Close: Set adoRegistro = Nothing
...
Private Sub cboEstado_Click()
    ...
    cmdReversar.Enabled = strCodEstado = "04"
    cmdProcesar.Enabled = strCodEstado = "02"
...
Private Sub ExportarExcel()
    ...
    Set frmFormulario = frmConfirmacionOrden
...
Private Sub cmdProcesar_Click()
    ...
    Dim strInversionOrdenXML        As String
    Dim objInversionOrdenXML        As DOMDocument60
    ...
    If adoRegistroAux.RecordCount > 0 Then
        Call XMLADORecordset(objInversionOrdenXML, "InversionOrden", "Orden", adoRegistroAux, strMsgError)
        strInversionOrdenXML = objInversionOrdenXML.xml
    
        adoComm.CommandText = "{ call up_IVProcInversionOrden('" & _
                                strCodFondo & "','" & gstrCodAdministradora & "','" & _
                                strFechaProceso & "','" & _
                                strInversionOrdenXML & "') }"
...
Private Sub cmdReversar_Click()
    ...
    If strEstado = Reg_Consulta Or strEstado = Reg_Edicion Then
        ...
        If strCodEstado = Estado_Orden_Procesada Then
        
            strMensaje = "Se procederá a reversar la OPERACION" & vbNewLine & vbNewLine & _
                "Número" & Space(6) & ":" & Space(1) & tdgConsulta.Columns(1) & vbNewLine & _
                "Descripción" & ":" & Space(1) & Trim(tdgConsulta.Columns(5)) & vbNewLine & vbNewLine & vbNewLine & _
                "¿ Seguro de continuar ?"
            ...
            If MsgBox(strMensaje, vbQuestion + vbYesNo + vbDefaultButton2, Me.Caption) = vbYes Then
                ...
                '*** Anular Cobertura corresponde ***
                adoComm.CommandText = "{ call up_IVReversarOperacion('" & strCodFondo & "','" & gstrCodAdministradora & "','" & _
                                        Trim(tdgConsulta.Columns(1)) & "')}"
                adoConn.Execute adoComm.CommandText
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmConfirmacionOrden = Nothing
    Call OcultarReportes
