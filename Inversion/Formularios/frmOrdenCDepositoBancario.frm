...
Begin VB.Form frmOrdenCDepositoBancario 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Ordenes - Certificados / Depósitos a Plazo"
   ClientHeight    =   9255
   ClientLeft      =   1500
   ClientTop       =   1680
   ClientWidth     =   14775
   ...
   EndProperty
   ForeColor       =   &H80000008&
   Icon            =   "frmOrdenCDepositoBancario.frx":0000
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab tabRFCortoPlazo 
      ...
      TabHeight       =   520
      TabCaption(0)   =   "Lista"
      TabPicture(0)   =   "frmOrdenCDepositoBancario.frx":0442
      ...
      TabPicture(1)   =   "frmOrdenCDepositoBancario.frx":045E
      ...
      Tab(1).Control(4)=   "cmdAccion"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "lblDescrip(85)"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).ControlCount=   6
      TabCaption(2)   =   "Negociación"
      TabPicture(2)   =   "frmOrdenCDepositoBancario.frx":047A
      ...
      Begin VB.Frame fraCriterio 
         ...
         Begin VB.CommandButton cmdEnviar 
            ...
            Height          =   735
            Left            =   12200
            Picture         =   "frmOrdenCDepositoBancario.frx":0496
            Style           =   1  'Graphical
            TabIndex        =   7
      ...
      Begin TrueOleDBGrid60.TDBGrid tdgConsulta 
         Bindings        =   "frmOrdenCDepositoBancario.frx":09F1
         Height          =   5145
         Left            =   240
         OleObjectBlob   =   "frmOrdenCDepositoBancario.frx":0A0B
         TabIndex        =   8
         Top             =   2640
         Width           =   13905
      End
   ...
   End
End
Attribute VB_Name = "frmOrdenCDepositoBancario"
