...
Begin VB.Form frmOperacionParticipeLista 
   ...
   Begin VB.Frame fraOperaciones 
      ...
      Begin TrueOleDBGrid60.TDBGrid tdgConsulta 
         Bindings        =   "frmOperacionParticipeLista.frx":0000
         Height          =   3855
         Left            =   210
         OleObjectBlob   =   "frmOperacionParticipeLista.frx":001A
         TabIndex        =   3
         Top             =   2340
         Width           =   11895
      End
   ...
   End
End
Attribute VB_Name = "frmOperacionParticipeLista"
...
Public Sub SubImprimir(Index As Integer)
    ...
    Dim strContinuar As String, strSeleccionRegistro As String
    strContinuar = "1"
    
    Select Case Index
        Case 1
            gstrNameRepo = "ParticipeOperacionLista"
        ...
        Case 2
            If Not adoConsulta.Recordset.EOF Then
                ...
                strSeleccionRegistro = "'Fch1' TO 'Fch2'"
                gstrSelFrml = strSeleccionRegistro
                
                Dim frmRangoMes As frmRangoFecha
                
                Set frmRangoMes = New frmRangoFecha
                
                frmRangoMes.dtpFechaInicial.Format = dtpCustom
                frmRangoMes.dtpFechaInicial.CustomFormat = "MM/yyyy"
                frmRangoMes.dtpFechaFinal.Format = dtpCustom
                frmRangoMes.dtpFechaFinal.CustomFormat = "MM/yyyy"
                
                frmRangoMes.dtpFechaInicial.Value = dtpFechaDesde.Value
                frmRangoMes.dtpFechaFinal.Value = dtpFechaDesde.Value
                frmRangoMes.dtpFechaFinal.Enabled = False
                
                frmRangoMes.Show vbModal
                    
                If gstrSelFrml <> "0" Then
                
                    gstrNameRepo = "ParticipeAtribucionRenta"
...
'                    aReportParamS(4) = strFechaHasta
                    ...
                    aReportParamS(3) = adoConsulta.Recordset.Fields("CodParticipe")
         ...
         Case 3
            ...
            'If SeleccionLista = 1 Then
                ...
                aReportParamS(0) = strCodFondoOperacion
                aReportParamS(1) = gstrCodAdministradora
                aReportParamS(2) = adoConsulta.Recordset.Fields("CodParticipe")
                aReportParamS(3) = adoConsulta.Recordset.Fields("NumOperacion")
...
Public Sub Buscar()
    ...
    strSql = "{ call up_PALstParticipeOperacion('" & strCodFondoOperacion & "','" & _
...
Private Sub CargarReportes()
    ...
    frmMainMdi.tlbMdi.Buttons("Reportes").ButtonMenus("Repo2").Text = "Certificado de Atribución"
    frmMainMdi.tlbMdi.Buttons("Reportes").ButtonMenus("Repo3").Visible = True
    frmMainMdi.tlbMdi.Buttons("Reportes").ButtonMenus("Repo3").Text = "Certificado de Retención"
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmOperacionParticipeLista = Nothing
    Call OcultarReportes
...
Private Sub tdgConsulta_FormatText(ByVal ColIndex As Integer, Value As Variant, Bookmark As Variant)
    ...
    If ColIndex >= 6 And ColIndex <= 9 Then
