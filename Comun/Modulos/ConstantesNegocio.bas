...
'*** Estado de una Orden de Inversión ***
...
'*** Código Tipo Comisionista *** NUEVO ACR
...
Public Const Mensaje_Adicion = "Seguro de adicionar la información ?"
Public Const Mensaje_Edicion = "Seguro de actualizar la información ?"
Public Const Mensaje_Eliminacion = "Seguro de eliminar la información ?"
Public Const Mensaje_Proceso_Exitoso = "El proceso terminó en forma exitosa..."
Public Const Mensaje_Proceso_NoExitoso = "El proceso tuvo errores, se procedió a revertir..."
Public Const Mensaje_Confirmacion_Exitoso = "El proceso de confirmación terminó en forma exitosa..."
Public Const Mensaje_Desconfirmacion_Exitoso = "El proceso de desconfirmación terminó en forma exitosa..."
Public Const Mensaje_Envio_Exitoso = "El Proceso de Envío terminó en forma exitosa..."
Public Const Mensaje_Desenvio_Exitoso = "El Proceso de Desenvío terminó en forma exitosa..."
Public Const Mensaje_Adicion_Periodo = "Seguro de generar el nuevo periodo contable ?"
Public Const Mensaje_Adicion_Periodo_Exitoso = "Se generó el nuevo periodo contable en forma exitosa..."
...
'*** Código Tipo Documento Identidad *** 'Agregado ACR
...
'*** Código Forma de Cálculo Intereses ***
...
'*** Código Tipo Movimiento Cuenta Fondo ***
...
'*** Código Tipo de Operación Captación ***
...
'*** Código Clase Operación Captación ***
...
'*** Código Clase Persona *** ' cambios ACR
...
'*** Código Tipo Orden de Inversión ***
...
'*** Código de Costos de Negociación ***
...
'*** Código Tipo de Cuenta de Inversión *** 'Estos codigos corresponden a la tabla virtual "TIPCTA"
...
'*** Código Tipo de Pago de Intereses ***
Public Const Codigo_Interes_Vencimiento = "001"
Public Const Codigo_Interes_Descuento = "002"

'*** Código Tipo Operación de Caja *** 'Estos codigos corresponden a la tabla virtual "OPECAJ"
...
Public Const Codigo_Caja_Detracción_AjusteRedondeoGanancia = "23"
Public Const Codigo_Caja_Detracción_AjusteRedondeoPerdida = "24"
...
'*** Código Forma Ingreso Calidad de Partícipe ***
...
'*** Código Tipo Dirección Postal ***
Public Const Codigo_Dirección_Domicilio = "01"
Public Const Codigo_Dirección_Trabajo = "02"

'*** Código Tipo de Limites ***
...
'*** Códigos de LimiteReglamentoEstructura  ***
Public Const Codigo_LimiteRE_Cliente = "09"

'*** Códigos de Líneas de Cliente ***
...
'*** Código Tipo de Comprobantes de Pago *** 'Completar segun se requiera!
...
'*** Código Tipo Indicador Cobertura ***
